...
public sealed class PlantillaNominaConfiguration : IEntityTypeConfiguration<PlantillaNomina>
{
    public void Configure(EntityTypeBuilder<PlantillaNomina> builder)
    {
        builder.ToTable("PlantillasNomina");
